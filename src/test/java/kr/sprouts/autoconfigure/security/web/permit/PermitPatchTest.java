...
import kr.sprouts.autoconfigure.security.web.application.mock.MockPermitPatchTestController;
...
@SpringBootTest(classes = {
        ...
        MockPermitPatchTestController.class
})
class PermitPatchTest {
    private Logger log = Logger.getLogger(PermitPatchTest.class.getCanonicalName());
    private static final String REQUEST_URI = "/mock/permit-patch";
    private static final String BODY = "permitPatch";
    ...
    @Autowired
    public PermitPatchTest(MockMvc mockMvc) {
    ...
    @Test
    void patchExt() throws Exception {
